...
return [
    ...
    /*
     * Custom options for Geocoder. You can add any additional options that
     * are supported by the Geocoder package.
     *
     * More info: https://github.com/spatie/geocoder
     */
    'custom_options' => [
        'apiKey' => env('GOOGLE_MAPS_API_KEY', ''), // Tambahkan kunci API di sini
        // Tambahkan opsi kustom lainnya jika diperlukan
    ],
];
